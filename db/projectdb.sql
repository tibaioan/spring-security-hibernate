...
INSERT INTO `configuration` VALUES (1,'support.email','tclinstacompute@gmail.com','Support Team Mail ID');
...
INSERT INTO `qrtz_cron_triggers` VALUES ('jobManagerTrigger','DEFAULT','0 0 1 * * ?','GMT');
...
INSERT INTO `qrtz_job_details` VALUES ('jobManager','DEFAULT',NULL,'com.tcl.cloud.jobs.JobManager','0','1','0','0','');
...
INSERT INTO `qrtz_scheduler_state` VALUES ('tcl-51007341308116875365',1308128096867,60000);
...
INSERT INTO `qrtz_triggers` VALUES ('jobManagerTrigger','DEFAULT','jobManager','DEFAULT','1',NULL,1308186000000,1304894824001,5,'WAITING','CRON',1300914477000,0,NULL,2,'');
...
INSERT INTO `users` VALUES (1,'ROOT','5dea6c738eed75b8667c7f4e334694f8','ROOT','','ROOT@ROOT',1),(2,'anishekm','5dea6c738eed75b8667c7f4e334694f8','Aneesh','Antony','aneesh.antony@tatacommunications.com',0);
...
-- Dump completed on 2011-06-15 14:35:22
